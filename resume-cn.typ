...
= #redact(alter: "roife")[占位符]
  ...
  == 项目开发
    ...
    #cventry(
        ...
        - （*主要负责人*）负责设计并编写了 IDE 的核心架构和增量计算流程，并完成了大部分的功能开发；
    ...
    #cventry(
         tl: "Ayame",
         tl_comments: [ · 毕昇杯比赛项目，从 C 子集到 LLVM-IR/ARMv7 编译器（Java / LLVM / ARMv7）],
    ...
    #cventry(
        ...
        - *Rust-lang Member*，rust-analyzer contributors team：工作集中在 #ghrepo("rust-lang/rust-analyzer", icon: false)，同时也贡献过 #ghrepo("rust-lang/rust-clippy", icon: false)，#ghrepo("rust-lang/rustup", icon: false)，#ghrepo("rust-lang/rust-mode", icon: false) ；
  ...
  #grid(
      ...
      gutter: 7pt,
      [*编程语言*], grid_par[不限于特定语言。熟悉 C, C++, Rust, Java, Python, Verilog；较熟悉 JS, Ruby, Swift, OCaml, Coq, Haskell 等。],
